import torch
import numpy as np
from models.ctm_simple_ei import ContinuousThoughtMachineSIMPLE
from models.modules import MNISTBackbone, QAMNISTIndexEmbeddings, QAMNISTOperatorEmbeddings

class ContinuousThoughtMachineSIMPLEQAMNIST(ContinuousThoughtMachineSIMPLE):
    def __init__(self,
                 iterations,
                 d_model,
                 d_input,
    ...
    def forward(self, x, z, track=False):
        ...
        for stepi in range(total_iterations):
            ...
            activated_state = torch.cat([exc_state, inh_state], dim=1)
